...
<div class="error-panel animated fadeInUp">
  ...
  <div class="error-ctrl">
    <el-button type="info" @click="$router.push({name: 'home'})"><i class="fa fa-home"></i>&nbsp;主页</el-button>
    <el-button @click="$router.back()" plain><i class="el-icon-arrow-left"></i>&nbsp;返回</el-button>
  </div>
